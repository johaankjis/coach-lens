...
`NO_TEXT` applies to missing or whitespace-only comments. `ALLOW_MINIMIZED` is a narrow permitted-content decision, not the absence of detected risk. After NFKC normalization and trimming, text crosses only when **all** of the following hold:
