            ...
            {training.state === "generated" && trainingDesign ? (
              <section className="home-card practice-package" aria-labelledby="practice-title">
                ...
                <p className="quiet">
                  ...
                  {alignment.state === "design_aligned"
                    ? "The AWS-6 alignment review found this package's design aligned; nothing is deployed and no learner is scored."
                    : alignment.state === "design_questioned"
                      ? `The AWS-6 alignment review questioned this package's design (${alignment.outcomeLabel.toLowerCase()}); review the concerns before any facilitator uses it.`
                      : "Independent AWS-6 alignment review of this package is pending."}
                </p>
