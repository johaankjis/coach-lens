  ...
  return {
    ...
    training_design: {
      ...
      design_basis: {
        ...
        intervention: { run_id: run, decision_type: "training", training_focus: "skill", validation_source: "m5_intervention_decision", summary: "Practice the resolution summary." },
...
describe("AWS-5 provider-backed training package", () => {
  ...
  it("shows the design basis, missing details, and scripted practice turns", () => {
    ...
    expect(screen.getByText(/Skill focus/)).toHaveTextContent("not yet solution-validated");
